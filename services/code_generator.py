...
class CodeGeneratorService:
    ...
    async def generate_fullstack_code(
        ...
        try:
            ...
            code = f"""// 🎯 MBTQ AUTO-GENERATED API INTEGRATION
// ═══════════════════════════════════════════════════════
...
// ═══════════════════════════════════════
// 🎨 FRONTEND (components/{component_name}.jsx)
// ═══════════════════════════════════════
  ...
  return (
    <div className="bg-gradient-to-br from-pink-50 to-purple-50 rounded-xl p-6 shadow-lg">
      ...
      <div className="flex items-center justify-between mb-4">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">📡 {api_name}</h2>
...
// ═══════════════════════════════════════
// Generated with ❤️ by MBTQ Auto-API
